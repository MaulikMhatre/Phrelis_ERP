...
import { User, Heart, Activity, CheckCircle, AlertTriangle, ArrowRight, Activity as Pulse, ShieldAlert, Binary, Fingerprint } from 'lucide-react';
...
export default function TriagePage() {
  ...
  const resetForm = () => {
    setFormData({ patient_name: '', patient_age: '', spo2: '', heart_rate: '', symptoms: '' });
    setResult(null);
  };

  return (
    <div className="min-h-screen bg-black text-slate-200 p-8 font-sans selection:bg-blue-500/30">
      {/* Background Neural link Glows */}
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <AnimatePresence mode="wait">
          {!result ? (
            ...
            /* HIGH-END PHRELIS OS ASSESSMENT UI */
            <motion.div 
              key="result" 
            ...
            >
              ...
              <div className="mb-12">
                <div className={`mx-auto w-24 h-24 rounded-3xl flex items-center justify-center mb-8 border-2 ${
                  result.esi_level <= 2 ? 'bg-red-500/10 border-red-500 text-red-500 shadow-[0_0_40px_rgba(239,68,68,0.2)]' : 'bg-emerald-500/10 border-emerald-500 text-emerald-500'
                }`}>
                ...
                <div className="inline-block mt-4">
                   <span className={`px-6 py-2 rounded-full font-black text-[10px] tracking-[0.3em] border ${
                     result.esi_level <= 2 ? 'bg-red-500/10 border-red-500/30 text-red-400' : 'bg-emerald-500/10 border-emerald-500/30 text-emerald-400'
                   }`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left mb-12">
                <div className="p-8 rounded-[2rem] bg-white/[0.03] border border-white/10 group hover:border-blue-500/30 transition-all">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xs font-bold text-slate-400 mt-2">{result.patient_age} Standard Cycles</span>
                  </div>
                </div>
